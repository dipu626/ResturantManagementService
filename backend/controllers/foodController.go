...
func GetFoods() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Need to learn mongo db aggregession
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occurs while listening food items"})
		}
...
func GetFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while fetching the food_id"})
		}

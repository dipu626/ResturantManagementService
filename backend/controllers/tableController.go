...
func GetTables() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("message: error occured while listing table items")
...
func GetTable() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("message: error occured while listing table item")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
...
func CreateTable() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		result, insertErr := tableCollection.InsertOne(
			ctx,
			table,
		)
